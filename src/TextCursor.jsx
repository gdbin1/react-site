// TextCursor.jsx (전체 내용 교체)
import { useState, useEffect, useRef } from "react";
// 'motion/react' 대신 'framer-motion'을 import 합니다.
import { motion, AnimatePresence } from "framer-motion";
import "./TextCursor.css";

// 'text' prop 대신 'imageSrc' prop을 사용하여 이미지 경로를 지정합니다.
const TextCursor = ({
    imageSrc = "/ren.png", // public 폴더에 있는 ren.png 파일 경로를 지정합니다.
    delay = 0.01,
    spacing = 10,
            ...
            <div className="text-cursor-inner">
                <AnimatePresence>
                    {trail.map((item) => (
                        ...
                        >
                            <img src={imageSrc} alt="cursor trail" className="trail-image" />
                        </motion.div>
                    ))}
                </AnimatePresence>
            </div>
